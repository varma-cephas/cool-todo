...
window.onload=()=>{
    loadComponents('todo_list', "./src/sections/todo_list.html");
    loadComponents('add_todo_btn', "./src/sections/add_todo_btn.html");
    loadComponents('todo_form', "./src/sections/todo_form.html");
